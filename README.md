...
# Dipy Brain Segmentation

The App uses Median Otsu method to do a brain segmentation of the diffusion-weighted magnetic resonance imaging data.
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_median_otsu`](https://dipy.org/documentation/latest/reference_cmd/dipy_median_otsu/) workflow.
